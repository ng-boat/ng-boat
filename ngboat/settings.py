...
ROOT_URLCONF = 'ngboat.urls'

WSGI_APPLICATION = 'ngboat.wsgi.application'
...
DATABASES['default'] = dj_database_url.config(
    default=os.getenv('DJANGO_DATABASE') or 'postgres://postgres:@localhost:5432/djangogirls') #'postgres://postgres:root@localhost:5432/djangogirls')
